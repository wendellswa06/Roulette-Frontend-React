...
export const Withdraw = () => {
  ...
  const handleWithdraw = ()=>{
    ...
    authData.withdraw(amount, callBack);
  }
    ...
    <>{
      ...
      <div className="card  procrash-bg-border">
        <div className="card-header">
          <h4 className="text-white prox-b f-s-18 mb-0">Withdraw  {authData.withdrawData?.withdrawables}</h4>
        </div>
          ...
          <div className="deposit-top">
            <div className="row">
              <div className="col-md-4">
                <div className="form-group">
                  <input 
                    ...
                    step="0.05" 
                    min="0.05" 
                    placeholder="Enter SOL to withdraw" 
                    id="deposit_coin" 
                    value={amount} 
                    onChange = {e=>{
              ...
              <div className="col-md-2">
                <button onClick={handleWithdraw} className="btn perple-btn btn-block prox-s-b f-s-16 pt-2 pb-2 coin_deposit_btn" id="coinDepositBtn" >Withdraw</button>
              </div>
            ...
            <div className="col-md-12 pt-2 pb-0">
              <div className="table-responsive">
                <table className="table bet_history_table" id="depositHistoryTable">
                  ...
                  {authData.withdrawData?.withdrawList.map((item : any, key : number)=>(
                      <tr key = {key}>
